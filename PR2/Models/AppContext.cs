...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=db_dem;Username=postgres;Password=1111");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Material>(entity =>
        {
            ...
            entity.HasOne(d => d.MaterialType).WithMany(p => p.Material)
        ...
        modelBuilder.Entity<Supplier>(entity =>
        {
            ...
            entity.HasOne(d => d.SupplierType).WithMany(p => p.Supplier)
        ...
        modelBuilder.Entity<SuppliersMaterial>(entity =>
        {
            ...
            entity.HasOne(d => d.Material).WithMany(p => p.SuppliersMaterial)
                .HasForeignKey(d => d.IdMaterial)
                .HasConstraintName("suppliers_materials_id_material_fkey");

            entity.HasOne(d => d.Supplier).WithMany(p => p.SuppliersMaterial)
